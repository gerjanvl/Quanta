...
namespace Quanta.Extensions.OData
{
    public static class ODataExtensions
    {
        public static Guid GetUserAdId(this ClaimsPrincipal user)
        {
            return Guid.Parse(user.Claims.FirstOrDefault(o => o.Type == "http://schemas.microsoft.com/identity/claims/objectidentifier")?.Value ?? throw new InvalidOperationException());
        }
